...
export default async function AdminEditProductPage({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-5 py-8 md:px-6">
      ...
      <section className="space-y-3 border-t border-border/80 pt-5 dark:border-white/10">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
            Datos base
          </p>
          <p className="mt-1 text-sm text-muted-foreground">
            Identidad del producto y configuración comercial general.
          </p>
        </div>
      ...
      <section className="space-y-3 border-t border-border/80 pt-5 dark:border-white/10">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Gestión de portada, orden de galería y archivos de imagen.
          </p>
        </div>
      ...
      <section className="space-y-3 border-t border-border/80 pt-5 dark:border-white/10">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Operá disponibilidad por talle y agregá variantes nuevas cuando haga falta.
          </p>
        </div>
        <AdminFormSection
