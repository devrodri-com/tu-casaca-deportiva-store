  ...
  return (
    <div className="storefront-shell">
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-4 px-6 py-10">
        <h1 className="text-3xl font-semibold tracking-tight text-zinc-900 dark:text-white">Pago pendiente</h1>
        <p className="max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-neutral-300">
          Mercado Pago informó que el pago quedó pendiente. Te avisamos cuando se acredite.
        </p>
